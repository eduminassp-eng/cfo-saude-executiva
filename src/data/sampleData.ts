...
export const sampleData: HealthData = {
  biomarkers: [
    { id: 'pa-sys', name: 'Pressão Arterial (Sistólica)', value: 128, unit: 'mmHg', targetMin: null, targetMax: 120, status: 'yellow', lastDate: '2025-11-15', note: '', category: 'Cardiovascular' },
    { id: 'pa-dia', name: 'Pressão Arterial (Diastólica)', value: 82, unit: 'mmHg', targetMin: null, targetMax: 80, status: 'yellow', lastDate: '2025-11-15', note: '', category: 'Cardiovascular' },
    { id: 'glicemia', name: 'Glicemia em Jejum', value: 95, unit: 'mg/dL', targetMin: 70, targetMax: 99, status: 'green', lastDate: '2025-10-20', note: '', category: 'Metabolismo' },
    { id: 'hba1c', name: 'Hemoglobina Glicada (HbA1c)', value: 5.4, unit: '%', targetMin: null, targetMax: 5.7, status: 'green', lastDate: '2025-10-20', note: '', category: 'Metabolismo' },
    { id: 'ldl', name: 'LDL Colesterol', value: 135, unit: 'mg/dL', targetMin: null, targetMax: 130, status: 'yellow', lastDate: '2025-10-20', note: 'Ligeiramente elevado', category: 'Cardiovascular' },
    { id: 'hdl', name: 'HDL Colesterol', value: 48, unit: 'mg/dL', targetMin: 40, targetMax: null, status: 'green', lastDate: '2025-10-20', note: '', category: 'Cardiovascular' },
    { id: 'trig', name: 'Triglicerídeos', value: 155, unit: 'mg/dL', targetMin: null, targetMax: 150, status: 'yellow', lastDate: '2025-10-20', note: '', category: 'Cardiovascular' },
    { id: 'creatinina', name: 'Creatinina', value: 1.0, unit: 'mg/dL', targetMin: 0.7, targetMax: 1.3, status: 'green', lastDate: '2025-10-20', note: '', category: 'Rins' },
    { id: 'tsh', name: 'TSH', value: 2.5, unit: 'mUI/L', targetMin: 0.4, targetMax: 4.0, status: 'green', lastDate: '2025-10-20', note: '', category: 'Hormonal' },
    { id: 'tgo', name: 'TGO (AST)', value: 28, unit: 'U/L', targetMin: null, targetMax: 40, status: 'green', lastDate: '2025-10-20', note: '', category: 'Fígado' },
    { id: 'tgp', name: 'TGP (ALT)', value: 35, unit: 'U/L', targetMin: null, targetMax: 41, status: 'green', lastDate: '2025-10-20', note: '', category: 'Fígado' },
    { id: 'ggt', name: 'GGT', value: 45, unit: 'U/L', targetMin: null, targetMax: 60, status: 'green', lastDate: '2025-10-20', note: '', category: 'Fígado' },
    { id: 'vitd', name: 'Vitamina D', value: 28, unit: 'ng/mL', targetMin: 30, targetMax: 100, status: 'yellow', lastDate: '2025-10-20', note: 'Suplementar', category: 'Hormonal' },
    { id: 'ferritina', name: 'Ferritina', value: 120, unit: 'ng/mL', targetMin: 30, targetMax: 300, status: 'green', lastDate: '2025-10-20', note: '', category: 'Metabolismo' },
    { id: 'imc', name: 'IMC', value: 26.5, unit: 'kg/m²', targetMin: 18.5, targetMax: 24.9, status: 'yellow', lastDate: '2025-11-15', note: 'Sobrepeso leve', category: 'Composição Corporal' },
    { id: 'cintura', name: 'Circunferência Abdominal', value: 94, unit: 'cm', targetMin: null, targetMax: 94, status: 'yellow', lastDate: '2025-11-15', note: 'No limite', category: 'Composição Corporal' },
    { id: 'psa', name: 'PSA', value: 0.8, unit: 'ng/mL', targetMin: null, targetMax: 4.0, status: 'green', lastDate: '2025-10-20', note: '', category: 'Urologia' },
    { id: 'testosterona', name: 'Testosterona Total', value: 520, unit: 'ng/dL', targetMin: 300, targetMax: 1000, status: 'green', lastDate: '2025-10-20', note: '', category: 'Hormonal' },
    { id: 'vitb12', name: 'Vitamina B12', value: 450, unit: 'pg/mL', targetMin: 200, targetMax: 900, status: 'green', lastDate: '2025-10-20', note: '', category: 'Metabolismo' },
    { id: 'pcr', name: 'PCR Ultrassensível', value: 1.8, unit: 'mg/L', targetMin: null, targetMax: 1.0, status: 'yellow', lastDate: '2025-10-20', note: 'Inflamação leve', category: 'Cardiovascular' },
    { id: 'apob', name: 'Apolipoproteína B', value: 105, unit: 'mg/dL', targetMin: null, targetMax: 90, status: 'yellow', lastDate: '2025-10-20', note: '', category: 'Cardiovascular' },
    { id: 'insulina', name: 'Insulina em Jejum', value: 8, unit: 'µUI/mL', targetMin: 2, targetMax: 13, status: 'green', lastDate: '2025-10-20', note: '', category: 'Metabolismo' },
    { id: 'ureia', name: 'Ureia', value: 32, unit: 'mg/dL', targetMin: 15, targetMax: 45, status: 'green', lastDate: '2025-10-20', note: '', category: 'Rins' },
    { id: 't4livre', name: 'T4 Livre', value: 1.2, unit: 'ng/dL', targetMin: 0.8, targetMax: 1.8, status: 'green', lastDate: '2025-10-20', note: '', category: 'Hormonal' },
  ],
  exams: [
